...
import { wshandler, wss } from "./api.js";
...
process.on("exit", (code) => {
    ...
    trySync(() => wshandler.broadcastReconnectNotification(), "Error closing websocket connections");
    trySync(() => wss.close(), "Error closing websocket server");
